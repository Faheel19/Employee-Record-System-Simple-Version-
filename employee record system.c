...
void login()
{
    ...
    do
{
	printf("\n  :::Human Resource Management (HRM) Software of Company XYZ:::  ");
    printf("\n\n  :::::::::::::::::::::::::: LOGIN  :::::::::::::::::::::::::::  ");
...
int main()
{
    ...
    */
    ...
    while(1)
    {
        ...
        gotoxy(30,9);
        printf("3> Modify and Search Employee's Records"); /// option for editing record
        gotoxy(30,11);
        ...
        case '3':  /// if user press 3 then do editing existing record
            ...
            while(another == 'y')
            {
                ...
                while(fread(&e,recsize,1,fp)==1)  /// fetch all record from file
                {
                    ...
                    {
                        printf("\nEnter new Name, Age, Address and Salary: ");
